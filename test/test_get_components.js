    ...
    it('should get data for wim detector',function(done){
        ...
        async.waterfall([function(cb){
                       ...
                       ,function(e,r){
                            ...
                            r.component_details.should.have.length(5)

                            r.component_details[0].detector.should.eql('765486')
                            r.component_details[1].detector.should.eql('718469')
                            r.component_details[2].detector.should.eql('717692')
                            r.component_details[3].detector.should.eql('wim.82.E')
                            r.component_details[4].detector.should.eql('716142')
